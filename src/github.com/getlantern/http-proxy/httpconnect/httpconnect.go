...
import (
	...
	"deng/src/github.com/getlantern/idletiming"
	"deng/src/github.com/getlantern/ops"

	"deng/src/github.com/getlantern/http-proxy/buffers"
	"deng/src/github.com/getlantern/http-proxy/filters"
	"deng/src/github.com/getlantern/http-proxy/utils"
)
