package flashlight
//如果之前安装过蓝灯，则要删除 /Users/yuandeqiao/Library/Application\ Support/Lantern 否则无法运行
...
import (
	...
	"deng/src/github.com/getlantern/fronted"
	"deng/src/github.com/getlantern/golog"
	"deng/src/github.com/getlantern/keyman"

	"deng/src/github.com/getlantern/flashlight/client"
	"deng/src/github.com/getlantern/flashlight/config"
